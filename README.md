...
- While my homelab's network infrastructure is critical to everything else running on it, so I avoid making changes unless something's actually broken — improvements wait until I'm doing a deliberate, complete overhaul rather than making small, frequent ad hoc changes.
