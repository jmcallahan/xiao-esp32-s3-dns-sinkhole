...
char hostName[MAX_HOST_LEN] = "put_it_in_my_sink_hole_daddy"; // Default Host name
char ST_SSID[MAX_HOST_LEN]  = "the_champagne_room"; //Default router ssid
char ST_Pass[MAX_PWD_LEN] = "Passw0rd!ButB3tt3r"; //Default router passd
...
char AP_SSID[MAX_HOST_LEN] = "little_sink_hole";
char AP_Pass[MAX_PWD_LEN] = "Passw0rd!ButB3tt3r";
char AP_ip[MAX_IP_LEN]  = "10.0.0.2"; // Leave blank to use 192.168.4.1
char AP_sn[MAX_IP_LEN]  = "255.255.255.0";
char AP_gw[MAX_IP_LEN]  = "10.0.0.1";
...
int netMode = 2; // 0=WiFi only, 1=Ethernet only, 2=Ethernet+AP
